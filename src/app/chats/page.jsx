...
const ChatsPage = () => {
  return (
    <div className="flex h-[calc(100svh-96px)] flex-col gap-2 overflow-hidden bg-white p-1 sm:h-[calc(100vh-60px)] sm:gap-4 sm:rounded-lg sm:p-4 sm:text-lg xl:text-sm 2xl:rounded-xl 2xl:text-lg">
