...
const ProfilePage = ({ searchParams }) => {
  return (
    <div className="flex min-h-[calc(100svh-96px)] flex-col gap-2 overflow-hidden bg-white p-1 text-center text-sm sm:h-[calc(100vh-16px)] sm:rounded-lg sm:p-4 sm:text-lg xl:text-sm 2xl:rounded-xl 2xl:text-lg">
